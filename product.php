                    ...
                    <form action="./search.php" method="GET">
                      <div class="form-group">
                        <div class="input-group">
                          ...
                          <input type="text" id="addon1" class="form-control" name="term" required="" title="Escriba nombre del local">
...
>>>>>>> 1581a131de9b3c52b40731aa4004c9bade563925
            ...
            <?php
                  ...
                  echo '<h2 class="text-center">Por favor seleccione una categoria o escriba el nombre del local para empezar</h2>';
                }
              else:
                echo '<h2 class="text-center">Lo sentimos, no hay locales registrados en la plataforma</h2>';
              endif;
            ?>
        </div>
    </section>
