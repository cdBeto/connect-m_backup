       ...
       <br>
        <div class="container">
              ...
              <div class="container-fluid">
                <div class="row">
                  ...
                  <?php
                      ...
                      echo '<h2 class="text-center">Lo sentimos, no hemos encontrado locales con el nombre <strong>"'.$search.'"</strong></h2>';
                    }
                  ?>
                </div>
              </div>
            <?php
                  ...
                  echo '<h2 class="text-center">Por favor escriba el nombre del local que desea buscar</h2>';
              }
            ?>
        </div>
    </section>
