       ...
       <br>
        <div class="container">
            <div class="page-header">
              <h1>RESEÑA DE LOCALES <small class="tittles-pages-logo"></small></h1>
            </div>

                <meta charset="utf-8" />
    <title>Sistema de Calificación y Reseñas</title>
...
<!-- fin del bloque de resenas -->

    <div class="container">

        <div class="card">
            <div class="card-header">Emerick</div>
            <div class="card-body">
                <div class="row">
                    <div class="col-sm-3 text-center">
                        <img src="./assets/img/slider1.jpg" alt="local" width="230">
                        <button type="button" name="add_review" id="add_review" class="btn btn-primary form-control mt-3">Califica este Local</button>
                    </div>
        ...
        <h3 class="mt-3 ml-4">Reseñas del Local:</h3>
